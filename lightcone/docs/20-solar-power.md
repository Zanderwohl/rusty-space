...
- **Heat.** The mechanic's missing counter-pressure. Closer is always better until it exists.
  Designed in [29-the-field.md](29-the-field.md), where collection becomes the field's intake and
  the analytic shadow gives way to [28-ship-form.md](28-ship-form.md)'s table.
