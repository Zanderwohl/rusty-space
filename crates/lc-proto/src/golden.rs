...
pub const FITTED: &[u8] = &[
    ...
    179, 166, 83, 211, 66, 0, 0, 0, 0, 0, 144, 128, 64, 1, 180, 157, 217, 121, 67, 120, 218,
    68, 0, 0, 0, 0, 128, 132, 46, 65, 2, 0, 0, 0, 0, 0, 0, 224, 63, 51, 51, 51, 51, 51, 51,
    211, 63, 102, 102, 102, 102, 102, 102, 238, 63, 1, 1, 0, 0, 0, 0, 0, 192, 147, 48, 65,
];
...
/// `Outbound::Illuminated { ship_id: 42, a 1 µm beam from [0, 0.6, 0.8] }`
pub const ILLUMINATED: &[u8] = &[
    23, 84, 0, 0, 0, 0, 0, 0, 0, 0, 51, 51, 51, 51, 51, 51, 227, 63, 154, 153, 153, 153,
    153, 153, 233, 63, 141, 237, 181, 160, 247, 198, 176, 62, 0, 200, 78, 103, 109, 193,
    139, 67, 128, 137, 122, 128, 184, 243, 162, 34,
];
